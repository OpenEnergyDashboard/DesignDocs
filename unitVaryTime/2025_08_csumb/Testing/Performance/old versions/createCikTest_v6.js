...
async function createCikData(startTimeStr, endTimeStr, stepUnit, meterUnitArg, graphicUnitArg, meterIdArg) {
	...
	try {
		...
		const readingsQuery = `
			SELECT meter_line_readings_unit_v3(
...
if (require.main === module) {
	...
	if (!startTimeArg || !endTimeArg || !stepUnitArg || !meterUnitArg || !graphicUnitArg || !meterIdArg) {
		console.error("Usage: node createCikTest_v6.js <startTime> <endTime> <stepUnit> <meterUnit> <graphicUnit> <meterId>");
		console.error(`Example: node createCikTest_v6.js "2020-01-01 00:00:00" "2021-01-01 00:00:00" day 25 1 3`);
		process.exit(1);
	}
