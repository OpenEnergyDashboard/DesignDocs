-- copy file to docker database container folder tmpt from local host terminal
-- user@host ~ % docker cp ./pgAdmin_OEDRawTimeVaryingConversionsTestCase_1.sql oed-backend-database-1:/tmp/
-- cd tmp
-- root@dba88b59a2ae:/tmp# psql -U oed
-- oed# \i /tmp/pgAdmin_OEDRawTimeVaryingConversionsTestCase_1.sql
