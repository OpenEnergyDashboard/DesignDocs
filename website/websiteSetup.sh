...
curl localhost:3000/api/csv/readings -X POST -F 'refreshReadings=true' -F 'meterName=eter D' -F 'headerRow=true' -F 'lengthVariation=8000000' -F 'gzip=false' -F 'email=test@example.com' -F 'password=password' -F 'csvfile=@oedData/ReadingsD.csv'
