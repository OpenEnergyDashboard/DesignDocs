...
|      | readings_ri_15_days_75.csv |  kWh        | kg of CO₂         | u2, u10, u12, c11, c12                     | 0.709      | 0         | 1440        | E5:G79        | -infinity               | +infinity             | expected_line_ri_15_mu_kWh_gu_kgCO2_st_-inf_et_inf.csv                              | should have daily points for 15 minute reading intervals and quantity units with +-inf start/end time & kWh as kg of CO2 |
|      | readings_ri_15_days_75.csv |  kWh        | metric ton of CO₂ | u2, u10, u11, u12, c11, c12, c13           | 7.09e-4    | 0         | 1440        | E5:G79        | -infinity               | +infinity             | expected_line_ri_15_mu_kWh_gu_MTonCO2_st_-inf_et_inf.csv                              | should have daily points for 15 minute reading intervals and quantity units with +-inf start/end time & kWh as metric ton of CO2 & chained |
|      | readings_ri_15_days_75.csv |  kWh        | lbs of CO₂        | u2, u10, u11, u12, u13, c11, c12, c13, c14 | 1.5598     | 0         | 1440        | E5:G79        | -infinity               | +infinity             | expected_line_ri_15_mu_kWh_gu_lbsCO2_st_-inf_et_inf.csv                              | should have daily points for 15 minute reading intervals and quantity units with +-inf start/end time & kWh as lbs of CO2 & chained & reversed |
|      | readings_ri_15_days_75.csv |  kWh        | MJ                | u1, u2, c1, c2                             | 3.6        | 0         | 60          | E173:G1612    | -infinity               | +infinity             | expected_line_ri_15_mu_kWh_gu_MJ_st_2022-08-25%00#00#00_et_2022-10-24%00#00#00.csv                                 | should have hourly points for middle readings of 15 minute for a 60 day period and quantity units & kWh as MJ |
|      | readings_ri_15_days_75.csv |  C          | F                 | u6, u7, u8, c5, c7                         | 1.8        | 32        | 60          | E173:G1612    | -infinity               | +infinity             | expected_line_ri_15_mu_C_gu_F_st_2022-08-25%00#00#00_et_2022-10-24%00#00#00.csv                                    | should have hourly points for middle readings of 15 minute for a 60 day period and raw units & C as F with intercept |
|      | readings_ri_15_days_75.csv |  kWh        | MJ                | u1, u2, c1, c2                             | 3.6        | 0         | 15          | E3269:G4612  | -infinity               | +infinity             | expected_line_ri_15_mu_kWh_gu_MJ_st_2022-09-21%00#00#00_et_2022-10-05%00#00#00.csv                                 | should have raW points for middle readings of 15 minute for a 14 day period and quantity units & kWh as MJ |
|      | readings_ri_15_days_75.csv |  C          | F                 | u6, u7, u8, c5, c7                         | 1.8        | 32        | 15          | E3269:G4612  | -infinity               | +infinity             | expected_line_ri_15_mu_C_gu_F_st_2022-09-21%00#00#00_et_2022-10-05%00#00#00.csv                                    | should have raw points for middle readings of 15 minute for a 14 day period and raw units & C as F with intercept |
