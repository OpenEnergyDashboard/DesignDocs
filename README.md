...
- [sqlTesting/sqlAndTesting.md](./sqlTesting/sqlAndTesting.md): Information on useful SQL commands for looking at the database and for using with testing for correct functioning.
